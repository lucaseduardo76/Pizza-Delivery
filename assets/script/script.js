let pizzaJson = [
    {id:1, name:'Mussarela', img:'assets/imagens/pizza.png', price:[9.80, 12.14, 20.19], sizes:['100g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:2, name:'Bahiana', img:'assets/imagens/pizza2.png', price:[7.47, 14.51, 24.29], sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:3, name:'Napolitana', img:'assets/imagens/pizza3.png', price:[6.84, 10.20, 32.12], sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:4, name:'4 Queijos', img:'assets/imagens/pizza4.png', price:[4.54, 13.45, 32.12], sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:5, name:'Moda da Casa', img:'assets/imagens/pizza5.png', price:[8.45, 14.20, 26.10], sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:6, name:'Bacalhau', img:'assets/imagens/pizza6.png', price:[6.84, 10.25, 27.19], sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:7, name:'Chocolate', img:'assets/imagens/pizza7.png', price:[9.87, 14.20, 18.19], sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:7, name:'Calabresa', img:'assets/imagens/pizza.png', price:[7.65, 15.20, 29.24], sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:7, name:'Camarão', img:'assets/imagens/pizza2.png', price:[8.45, 16.45, 24.19], sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'}
];
...
function openCar(){
    if(small1 === true || medium1 === true|| large1 === true){
...
function pizzaQuantity(){
    ...
    for(let n in listChoose){
        let u = parseInt(listChoose[n].quantity);            
        quantityCar = quantityCar + u;
        console.log(`Jason: ${u}, variavel: ${quantityCar}`)       
    }
